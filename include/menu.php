...
<div class="leftpanel">
    ...
    <div class="leftmenu">        
        <ul class="nav nav-tabs nav-stacked">
            ...
            <li class="sub-menu-a <?php active('page1.php');?>"><a href="#"><span class="sub-menu"></span> - Saved Invoices</a></li>
            ...
            <li class="sub-menu-a <?php active('page1.php');?>"><a href="#"><span class="sub-menu"></span> - Journal</a></li>
